...
Open cases in the backoffice by sending API requests to the workflow service.
 ...
 _Now the backoffice will run on http://localhost:5137/, and the workflow service will accept calls at https://be-demo-ekyc.namtp.id.vn/_
...
<details>
    ...
    <CodeBlock lang={`shell`} code={`curl --location 'https://be-demo-ekyc.namtp.id.vn/api/v1/external/workflows/run' \
...
<details>
    ...
    <CodeBlock lang={`shell`} code={`{
        ...
        "item": [
            {
                "name": "https://be-demo-ekyc.namtp.id.vn/api/v1/external/workflows/run",
                "request": {
                    "auth": {
                        "type": "bearer",
                        "bearer": [
                    ...
                    "url": {
                        "raw": "https://be-demo-ekyc.namtp.id.vn/api/v{/*  */}1/external/workflows/run",
                        "protocol": "http",
                        "host": [
                            "localhost"
                        ],
